...
const apiClient = new APIClient<FormData>("/update_driver_profile_picture");

interface Props {
  userId: number;
}

const useAddDriverProfilePicture = ({ userId }: Props) => {
...
export default useAddDriverProfilePicture;
